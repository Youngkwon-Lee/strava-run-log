...
async function readSupabaseRuns(opts = {}) {
  ...
  const params = new URLSearchParams({
    select: 'source,external_id,user_id,name,start_date,start_date_local,distance_meters,moving_time_sec,pace_sec_per_km,average_heartrate,average_cadence,subject_person_id,organization_id,org_client_profile_id,activity_session_id,linked_at,created_at,updated_at,raw',
