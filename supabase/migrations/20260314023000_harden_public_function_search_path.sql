-- P0 hardening: fix mutable search_path warnings on public functions
-- Source: Supabase advisor security lints (2026-03-14)
-- Scope: functions flagged by `function_search_path_mutable`
