...
-- Input: docs/db/DB_CLINICAL_CONCEPTS_SEED_V1_2026-03-22.json
-- Generated at: 2026-03-22T12:46:42.596Z
--
-- This seed intentionally inserts:
-- - concepts
-- - aliases
-- - only relationships whose source and target concepts are both present in the same seed file
...
commit;
-- Unresolved relationships in source JSON:
-- positive_slr indicates radicular_pain_hypothesis
-- slump_test_positive indicates radicular_pain_hypothesis
-- knee_valgus related_to movement_control_deficit
-- trunk_instability suggests_intervention postural_facilitation
-- head_control_deficit increases_risk_of postural_instability
-- trunk_control_deficit increases_risk_of deformity_progression_risk
-- gmfcs maps_to gross_motor_severity
-- home_program_adherence related_to care_state_engagement;
