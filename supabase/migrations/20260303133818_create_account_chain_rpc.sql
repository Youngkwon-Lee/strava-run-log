...
RETURNS TABLE(person_id UUID, organization_id UUID, member_id UUID, was_existing BOOLEAN)
...
BEGIN
  ...
  -- 1. Person: upsert (트리거가 이미 생성했을 수 있음)
  ...
  IF v_member_id IS NULL THEN
    SELECT id INTO v_member_id FROM organization_members
